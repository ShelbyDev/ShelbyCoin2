...
const string strMessageMagic = "ShelbyCoin Signed Message:\n";
...
int64_t GetProofOfWorkReward(int64_t nFees)
{
    ...
    nSubsidy >>= (pindexBest->nHeight / 216000);
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "ShelbyCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "Fri, 06 Mar 2015 15:52:45 GMT";
        CTransaction txNew;
        txNew.nTime = 1425657167;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        block.nVersion = 1;
        block.nTime    = 1425657167;
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 4724822;
		if(fTestNet)
        {
            block.nNonce   = 4724822;
        }
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x35de06804a94efad639691a018c2c51f638b2b341b0dc1add5a3899104f7be2c"));
        block.print();
